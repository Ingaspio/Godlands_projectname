...
public partial class @CameraControlActions : IInputActionCollection2, IDisposable
{
    ...
    private IActionCameraActions m_ActionCameraActionsCallbackInterface;
    ...
    public struct ActionCameraActions
    {
        ...
        {
            if (m_Wrapper.m_ActionCameraActionsCallbackInterface != null)
            {
                @Newaction.started -= m_Wrapper.m_ActionCameraActionsCallbackInterface.OnNewaction;
                @Newaction.performed -= m_Wrapper.m_ActionCameraActionsCallbackInterface.OnNewaction;
                @Newaction.canceled -= m_Wrapper.m_ActionCameraActionsCallbackInterface.OnNewaction;
                @ZoomCamera.started -= m_Wrapper.m_ActionCameraActionsCallbackInterface.OnZoomCamera;
                @ZoomCamera.performed -= m_Wrapper.m_ActionCameraActionsCallbackInterface.OnZoomCamera;
                @ZoomCamera.canceled -= m_Wrapper.m_ActionCameraActionsCallbackInterface.OnZoomCamera;
            }
            m_Wrapper.m_ActionCameraActionsCallbackInterface = instance;
            if (instance != null)
            {
